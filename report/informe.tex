...
\lstset{style=mystyle}
\lstinputlisting[language=sql]{src/queries/read_distribucion.sql}
...
\lstset{style=mystyle}
\lstinputlisting[language=sql]{src/queries/read_animals.sql}
...
\lstset{style=mystyle}
\lstinputlisting[language=sql]{src/queries/create.sql}

Ejecución de la consulta:

\begin{figure}[H]
      \centering
      \includegraphics[width=0.7\textwidth]{src/img/insert_seres_vivos.png}
...
\begin{figure}[H]
      \centering
      \includegraphics[width=0.7\textwidth]{src/img/tabla_seres__vivos.png}
...
\begin{figure}[H]
      \centering
      \includegraphics[width=0.7\textwidth]{src/img/update_animales_autoctonos.png}
      \caption{Ejecución de la consulta de actualización de la tabla animales\_autoctonos}
      \label{fig:update}
\end{figure}
...
\begin{figure}[H]
      \centering
      \includegraphics[width=0.7\textwidth]{src/img/tabla_animales_autoctonos.png}
      \caption{Resultado de la consulta de actualización de la tabla animales\_autoctonos}
      \label{fig:update_table}
\end{figure}

\item \textbf{Eliminación en la tabla seres\_vivos:} 
\lstset{style=mystyle}
\lstinputlisting[language=sql]{src/queries/delete.sql}
\end{itemize}
...
\begin{thebibliography}{99}
      ...
      \bibitem{2} \url{https://www.flaskapi.org/}
      \bibitem{3} \url{https://www.postgresql.org/}
      \bibitem{4} \url{https://www.postgresqltutorial.com/}
      \bibitem{5} \url{https://www.postgresqltutorial.com/postgresql-python/}
